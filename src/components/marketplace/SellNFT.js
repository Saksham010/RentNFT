    ...
    return (
        ...
        <div className="flex flex-col place-items-center mt-10" id="nftForm">
            ...
            <h3 className="text-center font-bold text-black-500 mb-8">Upload your NFT to the marketplace</h3>
                ...
                <div className="mb-6">
                    <label className="block text-black-500 text-sm font-bold mb-2" htmlFor="price">Price (in MATIC)</label>
                ...
                <button onClick={listNFT} className="font-bold mt-10 w-full bg-green-500 text-black rounded p-2 shadow-lg">
                    List NFT
                </button>
            </form>
        </div>
